...
const AddRoom = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!hotel) {
        toast.error("Register hotel first");
        return;
      }
  ...
  return (
    <div className="pb-20">
      <Title
        ...
        font="outfit"
        title="Add Room"
        subTitle="Upload hotel details, room pictures, room size and prices."
      />
      ...
      {!hotel && (
        ...
        >
          ...
          <button
            ...
            className="bg-black text-white px-8 py-4 rounded-xl mt-8 disabled:opacity-50"
          >
        ...
        <>
          ...
          <form onSubmit={handleSubmit} className="mt-12">
            ...
            <button
              type="submit"
              disabled={loading}
              className="bg-[#00ADEF] hover:bg-[#0094cc] text-white px-10 py-4 mt-10 rounded-xl font-semibold disabled:opacity-50"
            >
